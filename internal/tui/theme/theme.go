...
type Palette struct {
	...
	MarkdownBold   lipgloss.Color
	MarkdownItalic lipgloss.Color
	MarkdownCodeFG lipgloss.Color
	MarkdownCodeBG lipgloss.Color
...
var builtins = map[Name]Palette{
	Dark: {
		...
		MarkdownBold:   lipgloss.Color("#f3f3f3"),
		MarkdownItalic: lipgloss.Color("#d2d2d2"),
		MarkdownCodeFG: lipgloss.Color("#ffb86c"),
		MarkdownCodeBG: lipgloss.Color(""),
		MarkdownLink:   lipgloss.Color("#7fb6ff"),
	...
	Light: {
		...
		MarkdownBold:   lipgloss.Color("#111111"),
		MarkdownItalic: lipgloss.Color("#444444"),
		MarkdownCodeFG: lipgloss.Color("#b35c00"),
		MarkdownCodeBG: lipgloss.Color(""),
		MarkdownLink:   lipgloss.Color("#355f9d"),
